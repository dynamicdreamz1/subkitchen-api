...
ActiveRecord::Schema.define(version: 20_160_422_135_927) do
  ...
  add_index 'likes', %w(likeable_id likeable_type), name: 'index_likes_on_likeable_id_and_likeable_type', using: :btree
  add_index 'likes', %w(uuid likeable_id likeable_type), name: 'index_likes_on_uuid_and_likeable_id_and_likeable_type', unique: true, using: :btree

  create_table 'newsletter_receivers', force: :cascade do |t|
    t.string   'email'
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
  end
  ...
  add_index 'payments', %w(payable_id payable_type), name: 'index_payments_on_payable_id_and_payable_type', using: :btree
